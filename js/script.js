...
const elemFormulario = document.querySelector('[data-formulario]');

elemFormulario.addEventListener('submit', e => {
    e.preventDefault();
    ...
    localStorage.setItem('cadastro', JSON.stringify(dadosCliente));

    window.location.href = './abrir-conta-form-2.html';
});

const tiposDeErro = [
    'valueMissing', 'typeMismatch', 'patternMismatch', 'tooShort', 'customError'
];
